...
function gazettenews_scripts() {
	...
	wp_script_add_data( 'gazettenews-main', 'strategy', 'defer' );
	wp_localize_script(
		'gazettenews-main',
		'gnTheme',
		array(
...
function gazettenews_image_attrs( $attr ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'gazettenews_image_attrs' );
