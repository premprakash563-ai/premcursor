...
$installdefs = array(
    ...
    'copy' => array(
        ...
        array('from' => '<basepath>/custom/include/BS', 'to' => 'custom/include/BS'),
        array('from' => '<basepath>/custom/Extension/application/Ext/EntryPointRegistry', 'to' => 'custom/Extension/application/Ext/EntryPointRegistry'),
