<?php
/**
 * Front page — modern ThemeForest-style hardware storefront
 * inspired by Powerhouse structure (content rewritten).
 * Fully replaceable by editing this page in Elementor.
 *
...
$categories = array(
	array(
		'label' => __( 'Power Tools', 'hardware-forge' ),
		'img'   => 'cat-power-tools.jpg',
		'slug'  => 'power-tools',
	),
	array(
		'label' => __( 'Welding Machines & Accessories', 'hardware-forge' ),
		'img'   => 'cat-welding.jpg',
		'slug'  => 'welding',
	),
	array(
		'label' => __( 'Generators', 'hardware-forge' ),
		'img'   => 'cat-generators.jpg',
		'slug'  => 'generators',
	),
	array(
		'label' => __( 'Pumps & Motors', 'hardware-forge' ),
		'img'   => 'cat-pumps.jpg',
		'slug'  => 'pumps-motors',
	),
	array(
		'label' => __( 'Hand Tools', 'hardware-forge' ),
		'img'   => 'cat-hand-tools.jpg',
		'slug'  => 'hand-tools',
	),
	array(
		'label' => __( 'Lighting & Electrical', 'hardware-forge' ),
		'img'   => 'cat-electrical.jpg',
		'slug'  => 'lighting-electrical',
	),
	array(
		'label' => __( 'Water Systems', 'hardware-forge' ),
		'img'   => 'cat-water.jpg',
		'slug'  => 'water-systems',
	),
	array(
		'label' => __( 'Accessories & Abrasives', 'hardware-forge' ),
		'img'   => 'cat-accessories.jpg',
		'slug'  => 'accessories',
	),
);
...
$demo_products = array(
	array(
		'title' => __( 'Emergency Saltwater LED Lamp', 'hardware-forge' ),
		'price' => '₱399.00',
		'img'   => 'cat-electrical.jpg',
	),
	array(
		'title' => __( 'Heavy-Duty Long Rain Coat', 'hardware-forge' ),
		'price' => '₱690.00',
		'img'   => 'cat-accessories.jpg',
	),
	array(
		'title' => __( 'PVC Rain Boots — Lined', 'hardware-forge' ),
		'price' => '₱650.00',
		'img'   => 'cat-water.jpg',
	),
	array(
		'title' => __( 'Smart Inverter Generator 2.0KW', 'hardware-forge' ),
		'price' => '₱26,500.00',
		'img'   => 'cat-generators.jpg',
	),
	array(
		'title' => __( 'Electric-Start Gasoline Generator 7.5KW', 'hardware-forge' ),
		'price' => '₱39,500.00',
		'img'   => 'cat-generators.jpg',
	),
	array(
		'title' => __( 'Diesel Generator Electric Start 7.5KVA', 'hardware-forge' ),
		'price' => '₱69,000.00',
		'img'   => 'cat-pumps.jpg',
	),
);
	...
	<section class="hf-hero" aria-label="<?php esc_attr_e( 'Featured campaign', 'hardware-forge' ); ?>">
		...
		<div class="hf-hero__content hf-container">
			...
			<h1 class="hf-hero__headline">
				<?php esc_html_e( 'Register your tools. Lock in warranty that lasts.', 'hardware-forge' ); ?>
			</h1>
			<p class="hf-hero__support">
				<?php esc_html_e( 'Online product warranty for power tools, generators, and jobsite gear — built for crews who work hard every day.', 'hardware-forge' ); ?>
			</p>
			<div class="hf-hero__actions">
				<a class="hf-btn hf-btn--light" href="<?php echo esc_url( home_url( '/warranty/' ) ); ?>">
					<?php esc_html_e( 'Register warranty', 'hardware-forge' ); ?>
				</a>
				<a class="hf-btn hf-btn--ghost-light" href="<?php echo esc_url( $shop_url ); ?>">
					<?php esc_html_e( 'Shop catalogue', 'hardware-forge' ); ?>
				</a>
			</div>
		</div>
	</section>
		...
		<div class="hf-container">
			...
			<p class="hf-section__cta hf-section__cta--center">
				<a class="hf-btn hf-btn--primary" href="<?php echo esc_url( $shop_url ); ?>">
					<?php esc_html_e( 'View more', 'hardware-forge' ); ?>
	...
	<section class="hf-section hf-story">
		<div class="hf-container hf-story__grid">
			...
			<div class="hf-story__copy">
				...
				<p>
					<?php esc_html_e( 'From power tools to generators, we supply tradespeople and serious DIYers with dependable equipment — stocked nationwide and backed by service centers that keep your tools on the job.', 'hardware-forge' ); ?>
				</p>
				<a class="hf-btn hf-btn--primary" href="<?php echo esc_url( $about ); ?>">
					<?php esc_html_e( 'About us', 'hardware-forge' ); ?>
				</a>
			</div>
		</div>
	</section>
	...
	<section class="hf-section hf-featured">
		<div class="hf-container">
			...
			if ( class_exists( 'WooCommerce' ) ) {
				...
				if ( ! empty( $featured ) ) {
					$show_demo = false;
					echo '<div class="hf-woo-featured">';
					echo do_shortcode( '[products limit="6" columns="3" visibility="featured" orderby="popularity"]' );
					echo '</div>';
				}
			}
				...
				<ul class="hf-product-grid">
					<?php foreach ( $demo_products as $product ) : ?>
						<li class="hf-product">
							...
							<h3 class="hf-product__title">
								<a href="<?php echo esc_url( $shop_url ); ?>"><?php echo esc_html( $product['title'] ); ?></a>
							</h3>
							<p class="hf-product__price"><?php echo esc_html( $product['price'] ); ?></p>
							<a class="hf-btn hf-btn--primary hf-btn--block" href="<?php echo esc_url( $shop_url ); ?>">
								<?php esc_html_e( 'Quick view', 'hardware-forge' ); ?>
							</a>
						</li>
					<?php endforeach; ?>
				</ul>
	...
	<section class="hf-section hf-locate">
		<div class="hf-container hf-locate__inner">
			<div>
				...
				<a class="hf-btn hf-btn--dark" href="<?php echo esc_url( home_url( '/store-locator/' ) ); ?>">
					<?php esc_html_e( 'Store locator', 'hardware-forge' ); ?>
				</a>
			</div>
		...
		<div class="hf-container hf-club__inner">
			...
			<form class="hf-club__form" action="#" method="post" onsubmit="return false;">
				<div class="hf-club__row">
					<label class="screen-reader-text" for="hf-fname"><?php esc_html_e( 'First name', 'hardware-forge' ); ?></label>
					<input id="hf-fname" type="text" name="fname" placeholder="<?php esc_attr_e( 'First name', 'hardware-forge' ); ?>">
					<label class="screen-reader-text" for="hf-lname"><?php esc_html_e( 'Last name', 'hardware-forge' ); ?></label>
					<input id="hf-lname" type="text" name="lname" placeholder="<?php esc_attr_e( 'Last name', 'hardware-forge' ); ?>">
				</div>
				<label class="screen-reader-text" for="hf-email"><?php esc_html_e( 'Email address', 'hardware-forge' ); ?></label>
				<input id="hf-email" type="email" name="email" placeholder="<?php esc_attr_e( 'Email address', 'hardware-forge' ); ?>" required>
				<button class="hf-btn hf-btn--primary hf-btn--block" type="submit"><?php esc_html_e( 'Submit', 'hardware-forge' ); ?></button>
				<p class="hf-club__hint"><?php esc_html_e( 'Connect this form to Mailchimp / FluentCRM in Elementor, or replace the section with an Elementor Form widget.', 'hardware-forge' ); ?></p>
			</form>
		</div>
	</section>
	...
	<section class="hf-section hf-community">
		<div class="hf-container hf-community__grid">
			<div class="hf-community__copy">
				...
				<p>
					<?php esc_html_e( 'See how builders, partners, and training academies put durable tools to work — from woodshop demos to full jobsite builds. Whatever the task, tough gear makes it easier.', 'hardware-forge' ); ?>
				</p>
				<a class="hf-btn hf-btn--primary" href="<?php echo esc_url( home_url( '/campaigns/' ) ); ?>">
					<?php esc_html_e( 'Watch highlights', 'hardware-forge' ); ?>
				</a>
			</div>
			<figure class="hf-community__media">
				<img src="<?php echo esc_url( $uri . '/community.jpg' ); ?>" alt="<?php esc_attr_e( 'Workshop community', 'hardware-forge' ); ?>" loading="lazy" width="1600" height="900">
			</figure>
		</div>
	</section>
	...
	<section class="hf-franchise">
		<div class="hf-container hf-franchise__grid">
			...
			<div class="hf-franchise__copy">
				...
				<p><?php esc_html_e( 'Own a hardware franchise with proven branding, training, and supply lines. Build a business that powers local builders.', 'hardware-forge' ); ?></p>
				<p class="hf-franchise__phone"><a href="tel:+630000000000">(+63) 000 000 0000</a></p>
				<a class="hf-btn hf-btn--dark" href="<?php echo esc_url( home_url( '/franchising/' ) ); ?>">
					<?php esc_html_e( 'Franchise now', 'hardware-forge' ); ?>
				</a>
			</div>
		</div>
	</section>
